  ...
  return (
    <div className="container mx-auto divide-y">
      ...
      <div className="mt-4 py-4 px-4 flex justify-end sm:px-6">
        ...
        <button onClick={() => { updateProfile(currentUserProfile); history.push('/dashboard'); }} type="submit" className="ml-5 bg-indigo-700 border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          Save
        </button>
      </div>
    </div>
